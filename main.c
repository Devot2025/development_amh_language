...
int main(void) {
	Ans_Lex_Token_List* token_list = start_ans_lex_main("exapmle/std.ans");
	ans_token_list_call(token_list);
	Ans_Hash_Process_List* hash_list = gen_hash_process_list("std.ans");
	...
	//normal_debug_ans_ast_print(ast_node, 0);
